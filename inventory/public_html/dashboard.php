...
// $id=$_SESSION['id']; //get the userID of the user logged in

$qryUserInfo="SELECT * FROM user "; //get the personal information of the user       
$run=mysqli_query($qryUserInfo);
			...
			<div class="col-md-4">
				<div class="card mx-auto">
				  ...
				  <div class="card-body">
				    ...
				    <p class="card-text"><i class="fa fa-user">&nbsp;</i>CCC</p>
